...
<footer style="position: relative; overflow: hidden; background: linear-gradient(160deg, #221C16, #14100C 72%); color: #F5F1EA;">
  ...
  <div style="position: relative; z-index: 1; padding: clamp(70px,11vh,120px) clamp(28px,5vw,72px) 0;">
    <div class="ft-grid" style="display: grid; grid-template-columns: 1.6fr 1fr 1fr 1.1fr; gap: clamp(36px,4vw,64px);">
      ...
      <div class="ft-brand" style="display: flex; flex-direction: column; gap: 22px;">
        <div style="display: flex; align-items: center; gap: 12px;">
          <img src="<?php echo esc_url($theme_uri . '/assets/Astrix Logo-01.webp'); ?>" alt="Astrix Media logo" style="width: 30px; height: 30px; object-fit: contain; display: block;">
          <span style="font-weight: 700; font-size: 19px; letter-spacing: 0.22em;">ASTRIX</span>
          <span style="width: 1px; height: 15px; background: rgba(245,241,234,0.3); display: block;"></span>
          <span style="font-size: 11px; letter-spacing: 0.28em; color: rgba(245,241,234,0.6); font-weight: 500;">MEDIA</span>
        </div>
      ...
      <div style="display: flex; flex-direction: column; gap: 16px;">
        ...
        <div style="display: flex; flex-direction: column; gap: 4px;">
          <a href="<?php echo esc_url(home_url('/work')); ?>" class="ft-link">Work</a>
          <a href="<?php echo esc_url(home_url('/services')); ?>" class="ft-link">What We Do</a>
          <a href="<?php echo esc_url(home_url('/perspective')); ?>" class="ft-link">Insights</a>
          <a href="<?php echo esc_url(home_url('/studio')); ?>" class="ft-link">Who We Are</a>
          <a href="<?php echo esc_url(home_url('/contact')); ?>" class="ft-link">Let's Talk</a>
        </div>
      </div>

      <div style="display: flex; flex-direction: column; gap: 16px;">
        <span style="font-size: 11px; letter-spacing: 0.28em; text-transform: uppercase; color: rgba(245,241,234,0.45); font-weight: 500;">Disciplines</span>
        <div style="display: flex; flex-direction: column; gap: 4px;">
          <a href="<?php echo esc_url(home_url('/services')); ?>" class="ft-link">Brand Strategy</a>
          <a href="<?php echo esc_url(home_url('/services')); ?>" class="ft-link">Creative Studio</a>
          <a href="<?php echo esc_url(home_url('/services')); ?>" class="ft-link">Digital Experience</a>
          <a href="<?php echo esc_url(home_url('/services')); ?>" class="ft-link">Performance &amp; AI</a>
        </div>
      </div>
      ...
      <div style="display: flex; flex-direction: column; gap: 16px;">
        ...
        <a href="mailto:info@astrixmedia.in" style="color: #F5F1EA; font-size: 15px; font-weight: 500;">info@astrixmedia.in</a>
        <a href="tel:+919811734160" style="color: #F5F1EA; font-size: 15px; font-weight: 500;">+91 98117 34160</a>
        <p style="margin: 0; font-size: 13.5px; line-height: 1.6; color: rgba(245,241,234,0.6);">Studio in India.<br>Building brands worldwide.</p>
        <div style="display: flex; gap: 10px; margin-top: 4px;">
          <a href="tel:+919811734160" class="ft-social" aria-label="Call us">
          ...
          <a href="https://wa.me/919999477747" target="_blank" rel="noopener" class="ft-social" aria-label="WhatsApp">
          ...
          <a href="https://www.instagram.com/theastrixofficial" target="_blank" rel="noopener" class="ft-social" aria-label="Instagram">
          ...
          <a href="https://www.linkedin.com/company/astrixmedia/" target="_blank" rel="noopener" class="ft-social" aria-label="LinkedIn">
          ...
          <a href="https://www.facebook.com/profile.php?id=61570762880498" target="_blank" rel="noopener" class="ft-social" aria-label="Facebook">
    ...
    <div style="display: flex; align-items: center; justify-content: space-between; gap: 20px; flex-wrap: wrap; padding: 22px 0 30px; border-top: 1px solid rgba(245,241,234,0.12); font-size: 12.5px; color: rgba(245,241,234,0.5);">
      <span>&copy; <?php echo date('Y'); ?> Astrix Media. Where strategy meets story.</span>
...
<div id="astrix-float-group" style="position: fixed; right: clamp(14px, 3vw, 28px); bottom: clamp(14px, 3vw, 28px); z-index: 9998; display: flex; flex-direction: column; gap: 12px; align-items: center; opacity: 1; transform: translateY(0); transition: opacity 0.3s ease, transform 0.3s ease;">
  <a href="https://wa.me/919999477747" target="_blank" rel="noopener" aria-label="Chat on WhatsApp" class="ax-float-btn" style="background: #25D366;">
  ...
  <a href="tel:+919811734160" aria-label="Call us" class="ax-float-btn" style="background: #211C17;">

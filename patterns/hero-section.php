  ...
  <div class="grid-12" style="position: relative; z-index: 2; display: grid; grid-template-columns: repeat(12, 1fr); gap: 24px; padding: clamp(40px, 7vh, 90px) clamp(28px, 5vw, 72px) 0; align-items: center;">
    <div style="grid-column: 1 / span 7; display: flex; flex-direction: column; gap: clamp(26px, 3.6vh, 40px);">
      ...
      <h1 style="margin: 0; font-weight: 600; font-size: clamp(42px, 5.2vw, 88px); line-height: 1.03; letter-spacing: -0.035em; max-width: 15ch; text-wrap: balance;">
        <span style="display: block; opacity: 0; animation: riseIn 1.1s cubic-bezier(0.16, 1, 0.3, 1) 0.5s forwards;">Growth is a</span>
        <span style="display: block; opacity: 0; animation: riseIn 1.1s cubic-bezier(0.16, 1, 0.3, 1) 0.68s forwards;">systems <em style="font-family: 'Instrument Serif', serif; font-style: italic; font-weight: 400; letter-spacing: -0.01em; color: #C56A37;">challenge.</em></span>
      </h1>
      ...
      <div style="display: flex; align-items: center; gap: 28px; flex-wrap: wrap; opacity: 0; animation: riseIn 1.1s cubic-bezier(0.16, 1, 0.3, 1) 1.1s forwards;">
        <a href="/contact" data-magnetic class="ax-cta-dark" style="display: inline-flex; align-items: center; gap: 12px; background: linear-gradient(135deg, #2A2019, #1A1611); color: #F5F1EA; font-size: 14.5px; font-weight: 500; padding: 16px 30px; border-radius: 100px; transition: transform 0.35s cubic-bezier(0.16, 1, 0.3, 1), box-shadow 0.35s ease;">
